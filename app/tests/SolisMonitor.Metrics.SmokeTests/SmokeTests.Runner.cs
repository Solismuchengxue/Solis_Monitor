internal static partial class SmokeTests
{
    ...
    var tests = new (string Name, Action Run)[]
    {
        ...
        ("天气后台采集故障后自动恢复诊断", DiagnosticsRecoverFromWeatherCollectionFailure),
        ...
        ("失败指标周期保留最后完整快照", BackgroundCollectionGuardKeepsLastCompleteMetricsSnapshot),
        ("旧天气采集失败不覆盖新健康诊断", ReplacedWeatherCollectorFailureDoesNotOverrideHealthyDiagnostics),
        ("关闭中天气采集失败不更新诊断", ClosingWeatherCollectorFailureDoesNotOverrideHealthyDiagnostics),
        ("当前天气采集失败更新诊断", CurrentWeatherCollectorFailureUpdatesDiagnostics),
        ...
        ("Codex 周使用 Token 包含子代理任务", CodexWeeklyUsageIncludesSubagentSessions),
        ...
        ("Codex 周使用 Token 保留较大本地周期值", CodexWeeklyUsageKeepsLargerLocalTotal),
